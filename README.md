...
An autonomous, query-adaptive platform that dynamically plans and orchestrates compliance analysis workflows. Built using **LangGraph**, **Groq Llama 3.3 70B**, **Polars**, **scikit-learn**, **NetworkX**, **SHAP**, and **PyVis**.
 ...
 **intelligent, query-adaptive agent** that:
